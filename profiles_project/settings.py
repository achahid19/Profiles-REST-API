...
ALLOWED_HOSTS = ['ec2-16-171-239-172.eu-north-1.compute.amazonaws.com',
                 '127.0.0.1']
...
INSTALLED_APPS = [
    ...
    'rest_framework', # Name of the app within the rest_framework package.
    'rest_framework.authtoken', # use the token authentication method that comes out with the rest_framewrok.
    'profiles_api',
]
